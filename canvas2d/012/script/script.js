...
(() => {
    ...
    function render(){
        ...
        // 矩形を描画する（生成したパターンを文字列の代わりに色に指定する）
     ...
     * @param {string|CanvasGradient} [color] - 矩形を塗りつぶす際の色
     */
     ...
     * @param {string|CanvasGradient} [color] - 線を描画する際の色
     ...
     * @param {string|CanvasGradient} [color] - 多角形を描画する際の色
     */
     ...
     * @param {string|CanvasGradient} [color] - 円を描画する際の色
     */
     ...
     * @param {string|CanvasGradient} [color] - 扇形を描画する際の色
     */
     ...
     * @param {string|CanvasGradient} [color] - テキストを描画する際の色
